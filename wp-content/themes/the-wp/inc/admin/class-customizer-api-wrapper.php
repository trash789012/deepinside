<?php
	...
	class TheWP_Customizer_API_Wrapper {
		...
		public function enqueue_scripts() {
			...
			wp_enqueue_script( 
				'the-wp-customizer-js', 
				get_template_directory_uri() . '/inc/admin/js/script.js',
				array('jquery'),
				$this->_version,
				true
			);
			wp_localize_script( 'customizer-js', 'the_wp_upgrade', array( 'message' => __( 'Upgrade to Pro', 'the-wp' ) ) );
			
			
			
			////////////////////////
			wp_register_script( 'the_wp_customizer_custom', get_template_directory_uri() . '/inc/admin/js/customizer-custom-scripts.js', array( 'jquery' ), '20150619', true );
			$ceewp_misc_links = array(
									...
									'howdy_text'        	    => sprintf( __('Howdy, %1$s','the-wp' ), __( "If you like this theme, I'd appreciate any of the following:", 'the-wp' ) ),
									
									);
		
			//Add More Theme Options Buttons
			wp_localize_script( 'the_wp_customizer_custom', 'ceewp', $ceewp_misc_links );
			wp_enqueue_script( 'the_wp_customizer_custom' );
