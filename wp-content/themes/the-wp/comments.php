	...
	<?php if ( have_comments() ) : ?>
		...
		<nav id="comment-nav-above" class="navigation comment-navigation" role="navigation">
			...
			<div class="nav-links">
				...
				<div class="nav-previous"><?php previous_comments_link( __( 'Older Comments', 'the-wp' ) ); ?></div>
				<div class="nav-next"><?php next_comments_link( __( 'Newer Comments', 'the-wp' ) ); ?></div>
...
$fields =  array(
	...
	<label for="author">'.__('Name','the-wp').' '.($req?'*':'').'</label>
	<span></span>
	</div>',
	...
	<label for="email">'.__('Email','the-wp').' '.($req?'*':'').'</label>
	<span></span>
	</div>',
	...
	<label for="url">'.__('Website','the-wp').'</label>
	<span></span>
	</div>'
);
$comments_args = array(
	...
	<button class="button" type="submit">'.__( 'Post Comment','the-wp' ).'</button></div>',
