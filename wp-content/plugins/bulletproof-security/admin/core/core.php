...
$write_test = "";
	...
	if ( file_exists($root_htaccess_file) ) {
		...
		$text = '<font color="#fb0101" style="font-size:12px;"><strong>'.__('Cannot write to file: ', 'bulletproof-security').$root_htaccess_file.'</strong></font><br>';
		echo $text;
	}
	}
	}
	...
	if ( !is_writable($root_htaccess_file) ) {
		$text = '<font color="#fb0101" style="font-size:12px;"><strong>'.__('Error: Unable to write to the Root .htaccess file. If your Root .htaccess file is locked you must unlock first.', 'bulletproof-security').'</strong></font><br>';
		echo $text;
	}	
...
if ( isset( $_POST['submit-ProFlockLock'] ) && current_user_can('manage_options' )) {
	...
	if ( file_exists($bpsRootHtaccessOL) ) {
		...
		$text = '<font color="#fb0101" style="font-size:12px;"><strong><br>'.__('Unable to Lock your Root .htaccess file.', 'bulletproof-security').'</strong></font><br>';
		echo $text;
	}
}
...
if ( isset( $_POST['submit-ProFlockUnLock'] ) && current_user_can('manage_options') ) {
	...
	if ( file_exists($bpsRootHtaccessOL) ) {
		...
		$text = '<font color="#fb0101" style="font-size:12px;"><strong><br>'.__('Unable to Unlock your Root .htaccess file.', 'bulletproof-security').'</strong></font><br>';
		echo $text;
	}
}
?>
...
<div class="pro-links"><a href="http://www.ait-pro.com/aitpro-blog/5226/bulletproof-security-pro/whats-new-in-bulletproof-security-pro-11-6/" target="_blank" title="Link Opens in New Browser Window"><?php _e('Whats New in BPS Pro 11.6/11.61', 'bulletproof-security'); ?></a></div>
