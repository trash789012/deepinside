...
function bps_root_htaccess_status() {
	...
	if ( ! file_exists($filename) ) {
		$text = '<font color="#fb0101">'.__('ERROR: An htaccess file was NOT found in your root folder', 'bulletproof-security').'</font><br><br>'.__('wp-config.php is NOT htaccess protected by BPS', 'bulletproof-security').'</font><br><br>';
		echo $text;
...
function bps_check_php_version() {
	...
	if ( version_compare(PHP_VERSION, '5.0.0', '>=') ) {
    	$text = '<strong><span class="sysinfo-label-text">'.__('PHP Version Check: ', 'bulletproof-security').'</span><font color="green">&radic; '.__('Running PHP5', 'bulletproof-security').'</font></strong><br>';
		echo $text;
}
	if ( version_compare(PHP_VERSION, '5.0.0', '<') ) {
    	$text = '<font color="#fb0101"><strong>'.__('WARNING! BPS requires PHP5 to function correctly. Your PHP version is: ', 'bulletproof-security') . PHP_VERSION . '</strong></font><br>';
		echo $text;
	}
}
