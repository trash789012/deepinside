	...
	if ( current_user_can('manage_options') ) {
		...
		if ( esc_html($_SERVER['QUERY_STRING']) == 'page=bulletproof-security/admin/system-info/system-info.php' ) {
			...
			if ( 403 == $status_code2 && 403 == $status_code8 ) {
				...
				$text = __('mod_access_compat is Loaded|Order, Allow, Deny directives are supported|IfModule: Yes', 'bulletproof-security').'<br>';
				echo $text;				
				...
				$text = '<strong>'.$status_code8.':</strong> '.__('mod_access_compat is NOT Loaded|Order, Allow, Deny directives are NOT supported', 'bulletproof-security').'<br>';
				echo $text;
			...
			if ( 403 == $status_code3 && 403 == $status_code4 ) {
				...
				$text = __('mod_authz_core is Loaded|Order, Allow, Deny directives are supported|BC: Yes|IfModule: Yes', 'bulletproof-security').'<br>';
				echo $text;
				
			} elseif ( 403 == $status_code3 && 403 != $status_code4 ) {
			
				$text = __('mod_authz_core is Loaded|Order, Allow, Deny directives are NOT supported|BC: No|IfModule: Yes', 'bulletproof-security').'<br>';
				echo $text;		
			
			} elseif ( 403 != $status_code2 && 403 != $status_code3 && 403 != $status_code4 && 403 == $status_code8 ) {
				// IfModule: No
				$text = '<strong>'.$status_code3.':</strong> '.__('mod_authz_core Inconclusive: IfModule condition is not allowed/processed by Host Server', 'bulletproof-security').'<br>';
				echo $text;				
			
			} else {
				
				$text = __('mod_authz_core is NOT Loaded', 'bulletproof-security').'<br>';
				echo $text;	
			...
			if ( 403 == $status_code5 && 403 == $status_code6 ) {
				...
				$text = __('mod_authz_host is Loaded|Order, Allow, Deny directives are supported|BC: Yes|IfModule: Yes', 'bulletproof-security').'<br>';
				echo $text;
				
			} elseif ( 403 == $status_code5 && 403 != $status_code6 ) {
			
				$text = __('mod_authz_host is Loaded|Order, Allow, Deny directives are NOT supported|BC: No|IfModule: Yes', 'bulletproof-security').'<br>';
				echo $text;		
			
			} elseif ( 403 != $status_code2 && 403 != $status_code5 && 403 != $status_code5 && 403 == $status_code8 ) {
				// IfModule: No			
				$text = '<strong>'.$status_code5.':</strong> '.__('mod_authz_host Inconclusive: IfModule condition is not allowed/processed by Host Server', 'bulletproof-security').'<br>';
				echo $text;				
			
			} else {
				
				$text = __('mod_authz_host is NOT Loaded', 'bulletproof-security').'<br>';
				echo $text;	
			}
